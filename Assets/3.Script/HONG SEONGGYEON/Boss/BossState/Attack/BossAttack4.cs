...
public class BossAttack4 : BossStateBase
{
    private float OriginAttack;
    public override void Enter()
    {
        base.Enter();
        bossController.PlayAnimation("Attack4");
        ...
        bossController.mon_CO.AttackPoint *= bossController.bossModel.Attack4;
    }

    public override void Update()
    {
        if (bossController.bossModel.isGroggy) bossController.SwitchState(BossState.StunStart);
        if (bossController.IsAnimationFinished("Attack4"))
        {

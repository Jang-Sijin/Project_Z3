...
public class BossAttack5 : BossStateBase
{
    private float OriginAttack;
    public override void Enter()
    {
        base.Enter();
        bossController.PlayAnimation("Attack5");
        ...
        bossController.mon_CO.AttackPoint *= bossController.bossModel.Attack5;
    }

    public override void Update()
    {
        if (bossController.bossModel.isGroggy) bossController.SwitchState(BossState.StunStart);
        if (bossController.IsAnimationFinished("Attack5"))
        {
